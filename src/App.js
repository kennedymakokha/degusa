        ...
        <Router>
            <ScrollToTop>
                <Switch>
                    ...
                    {/* <Route exact path={`${process.env.PUBLIC_URL + "/our-projectseeee"}`}
                        component={BlogGridRightSidebar} /> */}
                    <Route exact path={`${process.env.PUBLIC_URL + "/our-projects"}`}
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/project/:blogID"}`} component={BlogDetailsPage} />
